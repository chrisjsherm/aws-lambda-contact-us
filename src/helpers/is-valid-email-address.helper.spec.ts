...
describe('Test email addresses against validator', () => {
  it('should consider valid email addresses valid', () => {
    // Assert
  ...
  it('should consider invalid email addresses invalid', () => {
    // Assert
  ...
  it('should consider valid but unsupported email addresses invalid', () => {
    // Assert
  ...
  it('should consider undefined calls invalid', (): void => {
    // Assert
    expect(isValidEmailAddress(undefined as unknown as string)).toBe(false);
  });

  it('should consider non-string calls invalid', (): void => {
    // Assert
    expect(isValidEmailAddress(12 as unknown as string)).toBe(false);
  });

  it('should consider empty calls invalid', (): void => {
    // Assert
